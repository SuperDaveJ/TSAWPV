...
/******************************************************************************
** This file is changed to make it work for both SCORM and CD versions of a
** course.
** All error alert messages are removed except the one in doLMSInitialize() function.
** That is the only alert a user will see if running the course out of an LMS.
**
** modified date: August, 2008
** modified by: Xihai Zhang, C2 Technologies, Inc.
*******************************************************************************/
